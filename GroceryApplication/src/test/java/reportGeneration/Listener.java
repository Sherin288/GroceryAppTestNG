...
//Extent report utility returns a template but listener is used to add data to the template , that is tc passed and failed
public class Listener implements ITestListener { //ITestListener is an in build method 

		ExtentTest test;
		ExtentReports extent = ExtentReportUtility.createExtentReports();//template is fetched from extent report utility
		ThreadLocal<ExtentTest> extentTest = new ThreadLocal<ExtentTest>();

		public void onTestStart(ITestResult result) {//When our test case is started to execute it retrieve test case name and description is retrieved and set to the report
		...
		public void onTestSuccess(ITestResult result) {//to handle passed test case
		 ...
		 */
		  ...
		  public void onTestFailure(ITestResult result) {//To handle failed test case
		...
		public void onFinish(ITestContext context) {//On finish passes all the value till the end of excution

			ITestListener.super.onFinish(context);
			extent.flush();//all the data in extent object is passed to report using flush inbuilt function
		}
